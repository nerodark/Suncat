...
namespace menelabs.core
{
    ...
    internal class DelayedEvent
    {
        ...
        public virtual bool IsDuplicate(object obj)
        {
            ...
            // We also eliminate Changed and Deleted events that follow recent Created events
    ...
    internal class FileSystemSafeWatcher
    {
        ...
        /// </summary>
        /// <value>An ISite for the FileSystemWatcher.</value>
        public ISite Site
        {
            get
            {
                    ...
                    lock (_events.SyncRoot)
                    {
                        ...
                        for (int i = 0; i < _events.Count; i++)
                        {
                            ...
                            if (current.Delayed)
                            {
                                ...
                                if (raiseEvent && (current.Args.ChangeType == WatcherChangeTypes.Created || current.Args.ChangeType == WatcherChangeTypes.Changed))
                                {
